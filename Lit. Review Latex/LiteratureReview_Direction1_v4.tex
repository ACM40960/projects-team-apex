% ============================================================
%  Literature Review — Direction 1  (9-paper, concept-driven)
...
%
%  Style: thematic / concept-driven related-work prose with
%         subtle numeric citations (IEEE-style), modelled on
%         a representative Irish PhD thesis related-work chapter.
%
%  Citation style : numeric (biblatex, style=ieee)
...
% -- Bibliography (numeric IEEE style via biblatex) ----------
\usepackage[
  backend   = biber,
  style     = ieee,
  sorting   = none
...
% -- Abstract ------------------------------------------------
\begin{abstract}
This review surveys the research landscape underpinning a deep learning
...
coverage guarantees --- and locates, within that landscape, the gap the
